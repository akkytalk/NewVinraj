...
function IncomingMaterialInspectionChecklist(props) {
  let data = {
    ...
    return (
      <Card>
        <CardHeader className="bg-warning text-white">
          <div className="">
            <strong>Incoming Material Inspection Checklist</strong>
            ...
            >
              Add Incoming Material Inspection Checklist
            </Button>
          </div>
          <Modal className="modal-info modal-lg" isOpen={modal} toggle={toggle}>
            <ModalHeader toggle={toggle}>
              Add New Incoming Material Inspection Checklist
            </ModalHeader>
...
export default connect(
  mapStateToProps,
  mapDispatchToProps
)(IncomingMaterialInspectionChecklist);
