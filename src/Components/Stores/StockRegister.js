      ...
      <Card>
        <CardHeader className="bg-warning text-white">
          ...
          <Modal className="modal-info modal-lg" isOpen={modal} toggle={toggle}>
            <ModalHeader toggle={toggle}>Add New Stock Register</ModalHeader>
...
export default connect(mapStateToProps, mapDispatchToProps)(StockRegister);
