...
function RecordOfDisposalOfShelfOfItems(props) {
  let data = {
    ...
    return (
      <Card>
        <CardHeader className="bg-warning text-white">
          <div className="">
            <strong>Record Of Disposal Of Shelf Of Items</strong>
            ...
            >
              Add Record Of Disposal Of Shelf Of Items
            </Button>
          </div>
          <Modal className="modal-info modal-lg" isOpen={modal} toggle={toggle}>
            <ModalHeader toggle={toggle}>
              Add New Record Of Disposal Of Shelf Of Items
            </ModalHeader>
...
export default connect(
  mapStateToProps,
  mapDispatchToProps
)(RecordOfDisposalOfShelfOfItems);
