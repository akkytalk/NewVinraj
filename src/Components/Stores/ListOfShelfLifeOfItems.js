...
function ListOfShelfLifeOfItems(props) {
  let data = {
    ...
    return (
      <Card>
        <CardHeader className="bg-warning text-white">
          <div className="">
            <strong>List Of Shelf Life Of Items</strong>
