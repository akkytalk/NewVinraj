...
function SalesTargetPlanVsActual(props) {
  let data = {
    ...
    return (
      <Card>
        <CardHeader className="bg-warning text-white">
          <div className="">
            <strong>Sales Target Plan Vs Actual</strong>
