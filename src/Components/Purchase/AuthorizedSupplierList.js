...
function AuthorizedSupplierList(props) {
  let data = {
    ...
    return (
      <Card>
        <CardHeader className="bg-warning text-white">
          <div className="">
            <strong>Authorized Supplier List</strong>
