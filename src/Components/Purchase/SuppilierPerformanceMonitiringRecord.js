...
function SuppilierPerformanceMonitiringRecord(props) {
  let data = {
    ...
    return (
      <Card>
        <CardHeader className="bg-warning text-white">
          <div className="">
            <strong>Suppilier Performance Monitiring Record</strong>
            ...
            >
              Add Suppilier Performance Monitiring Record
            </Button>
          </div>
          <Modal className="modal-info modal-lg" isOpen={modal} toggle={toggle}>
            <ModalHeader toggle={toggle}>
              Add New Suppilier Performance Monitiring Record
            </ModalHeader>
...
export default connect(
  mapStateToProps,
  mapDispatchToProps
)(SuppilierPerformanceMonitiringRecord);
