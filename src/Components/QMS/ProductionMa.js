      ...
      <Card>
        <CardHeader className="bg-warning text-white">
          ...
          <Modal className="modal-info modal-lg" isOpen={modal} toggle={toggle}>
            <ModalHeader toggle={toggle}>Add New Production Ma</ModalHeader>
...
export default connect(mapStateToProps, mapDispatchToProps)(ProductionMa);
