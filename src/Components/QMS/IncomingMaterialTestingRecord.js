...
function IncomingMaterialTestingRecord(props) {
  let data = {
    ...
    return (
      <Card>
        <CardHeader className="bg-warning text-white">
          <div className="">
            <strong>Incoming Material Testing Record</strong>
            ...
            >
              Add Incoming Material Testing Record
            </Button>
          </div>
          <Modal className="modal-info modal-lg" isOpen={modal} toggle={toggle}>
            <ModalHeader toggle={toggle}>
              Add New Incoming Material Testing Record
            </ModalHeader>
