...
function ProductionReportCf(props) {
  let data = {
    ...
    return (
      <Card>
        <CardHeader className="bg-warning text-white">
          <div className="">
            <strong>Production Report Cf</strong>
...
export default connect(mapStateToProps, mapDispatchToProps)(ProductionReportCf);
