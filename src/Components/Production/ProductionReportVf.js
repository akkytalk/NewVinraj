...
function ProductionReportVf(props) {
  let data = {
    ...
    return (
      <Card>
        <CardHeader className="bg-warning text-white">
          <div className="">
            <strong>Production Report Vf</strong>
...
export default connect(mapStateToProps, mapDispatchToProps)(ProductionReportVf);
