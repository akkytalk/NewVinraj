      ...
      <Card>
        <CardHeader className="bg-warning text-white">
          ...
          <Modal className="modal-info modal-lg" isOpen={modal} toggle={toggle}>
            <ModalHeader toggle={toggle}>Add New Stock Report Vf</ModalHeader>
...
export default connect(mapStateToProps, mapDispatchToProps)(StockReportVf);
