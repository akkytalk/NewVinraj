...
function BreakdownMaintenanceAnalysisRecord(props) {
  let data = {
    ...
    return (
      <Card>
        <CardHeader className="bg-warning text-white">
          <div className="">
            <strong>Breakdown Maintenance Analysis Record</strong>
            ...
            >
              Add Breakdown Maintenance Analysis Record
            </Button>
          </div>
          <Modal className="modal-info modal-lg" isOpen={modal} toggle={toggle}>
            <ModalHeader toggle={toggle}>
              Add New Breakdown Maintenance Analysis Record
            </ModalHeader>
...
export default connect(
  mapStateToProps,
  mapDispatchToProps
)(BreakdownMaintenanceAnalysisRecord);
