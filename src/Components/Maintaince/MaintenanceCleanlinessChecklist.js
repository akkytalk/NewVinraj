...
function MaintenanceCleanlinessChecklist(props) {
  let data = {
    ...
    return (
      <Card>
        <CardHeader className="bg-warning text-white">
          <div className="">
            <strong>Maintenance Cleanliness Checklist</strong>
            ...
            >
              Add Maintenance Cleanliness Checklist
            </Button>
          </div>
          <Modal className="modal-info modal-lg" isOpen={modal} toggle={toggle}>
            <ModalHeader toggle={toggle}>
              Add New Maintenance Cleanliness Checklist
            </ModalHeader>
...
export default connect(
  mapStateToProps,
  mapDispatchToProps
)(MaintenanceCleanlinessChecklist);
