...
function ListOfSuppliersForMaintenanceActivities(props) {
  let data = {
    ...
    return (
      <Card>
        <CardHeader className="bg-warning text-white">
          <div className="">
            <strong>List Of Suppliers For Maintenance Activities</strong>
            ...
            >
              Add List Of Suppliers For Maintenance Activities
            </Button>
          </div>
          <Modal className="modal-info modal-lg" isOpen={modal} toggle={toggle}>
            <ModalHeader toggle={toggle}>
              Add New List Of Suppliers For Maintenance Activities
            </ModalHeader>
...
export default connect(
  mapStateToProps,
  mapDispatchToProps
)(ListOfSuppliersForMaintenanceActivities);
