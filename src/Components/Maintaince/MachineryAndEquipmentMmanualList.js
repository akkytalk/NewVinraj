...
function MachineryAndEquipmentMmanualList(props) {
  let data = {
    ...
    return (
      <Card>
        <CardHeader className="bg-warning text-white">
          <div className="">
            <strong>Machinery And Equipment MmanualList</strong>
            ...
            >
              Add Machinery And Equipment MmanualList
            </Button>
          </div>
          <Modal className="modal-info modal-lg" isOpen={modal} toggle={toggle}>
            <ModalHeader toggle={toggle}>
              Add New Machinery And Equipment MmanualList
            </ModalHeader>
...
export default connect(
  mapStateToProps,
  mapDispatchToProps
)(MachineryAndEquipmentMmanualList);
