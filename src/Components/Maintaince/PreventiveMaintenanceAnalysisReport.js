...
function PreventiveMaintenanceAnalysisReport(props) {
  let data = {
    ...
    return (
      <Card>
        <CardHeader className="bg-warning text-white">
          <div className="">
            <strong>Preventive Maintenance Analysis Report</strong>
            ...
            >
              Add Preventive Maintenance Analysis Report
            </Button>
          </div>
          <Modal className="modal-info modal-lg" isOpen={modal} toggle={toggle}>
            <ModalHeader toggle={toggle}>
              Add New Preventive Maintenance Analysis Report
            </ModalHeader>
...
export default connect(
  mapStateToProps,
  mapDispatchToProps
)(PreventiveMaintenanceAnalysisReport);
