      ...
      <Card>
        <CardHeader className="bg-warning text-white">
          ...
          <Modal className="modal-info modal-lg" isOpen={modal} toggle={toggle}>
            <ModalHeader toggle={toggle}>Add New Prefix</ModalHeader>
            {props.prefix?.isPostLoading && <Loader2 />}
            <ModalBody>
              <Formik
                initialValues={{
                  form_id: "",
...
export default connect(mapStateToProps, mapDispatchToProps)(NewPrefix);
